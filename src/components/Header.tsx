    ...
    <header className="header">
      <div className="header-inner">
        ...
        <nav className={`nav ${mobileOpen ? 'open' : ''}`}>
          ...
          <Link to="/collections" className={location.pathname.startsWith('/collections') ? 'active' : ''}>Collections</Link>
        ...
        <div className="header-actions">
          ...
          <a href="https://discord.com/invite/AYEsSG9TVm" target="_blank" rel="noopener noreferrer" className="icon-btn discord-btn" title="Join Discord">
